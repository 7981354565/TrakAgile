...
import '../Css/ManagerTravelAttendanceMap.css'; // Custom styles

const ManagerTravelAttendenceMap = ({ locations }) => {
...
export default ManagerTravelAttendenceMap; // Export the component
