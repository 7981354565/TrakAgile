...
import TravelAttendenceMap from './TravelAttendanceMap';
import './TravelAttendence.css';

const TravelAttendence = ({ record }) => {
  ...
  return (
    <Container fluid className="form-container">
      ...
      <Row>
        ...
        {/* Map Section */}
        <Col md={6}>
          <TravelAttendenceMap locations={pointWkt} />
        </Col>
      </Row>
...
export default TravelAttendence;
